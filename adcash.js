...
var builder = new ReopenUrlBuilder("https:\/\/www.predictivdisplay.com\/a\/display.php?r=2433355&treqn=1951316205&runauction=1&crr=d423c22b6b743e8b332e,EmRyUib7f26040060b524bf8dda&rtid=5cee1fc0ae0c3");
var url = builder.build();

    var content = '<iframe width="336" height="280" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" id="5cee1fc0ae0c3"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    //var content = '<iframe width="336" height="280" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5cee1fc0ae0c3"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5cee1fc0ae0c3').removeAttribute('sandbox');
    }