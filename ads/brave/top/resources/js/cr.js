...
var cr = cr || function(global) {
   ...
   */
    function defineProperty(obj, name, opt_kind, opt_setHook) {
        ...
        const kind = /** @type {PropertyKind} */
        (opt_kind || PropertyKind.JS);
    ...
    function makePublic(ctor, methods, opt_target) {
        methods.forEach(function(method) {
            ctor[method] = function() {
                const target = opt_target ? // Disable document.getElementById restriction since cr.js should
                // not depend on util.js.
                // eslint-disable-next-line no-restricted-properties
                document.getElementById(opt_target) : ctor.getInstance();
